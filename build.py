...
def build():
    ...
    ext_module_bcp = declare_cython_extension( "linear_segment.bcpseg.bcp_segment", use_openmp=False , include_dirs=include_dirs )
    ext_module_cbs = declare_cython_extension( "linear_segment.cbseg.cbseg", use_openmp=False , include_dirs=include_dirs )
